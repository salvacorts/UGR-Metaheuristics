...
\end{table}
	...
	Si bien los algoritmos genéticos y los meméticos son planteamientos mucho más sofisticados que la búsqueda local, necesitan ser ajustando inteligentemente para su correcto funcionamiento:\\
	...
	Hay que tener muy en cuenta el tiempo a la hora de ajustar estos parámetros pues por ejemplo ejecutar una búsqueda local sobre todos los cromosomas de una población de 100 cromosomas es muy costoso y podemos conseguir el mismo resultado calibrando el porcentaje sobre los que ejecutar la búsqueda y el número máximo de evaluaciones.\\
